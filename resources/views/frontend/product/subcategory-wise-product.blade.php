                                                    ...
                                                    <div class="accordion-inner">
                                                        <ul>
                                                            ...
                                                            @foreach($subcategories as $subcat)
                                                                <li>
                                                                    @if(session()->get('language')=='english')
                                                                        <a href="{{url('product/subcategory/en/'.$subcat->id."/".$subcat->subcategory_slug_en)}}">
                                                                            {{$subcat->subcategory_name_en}}
                                                                        </a>
                                                                    @else
                                                                        <a href="{{url('product/subcategory/tr/'.$subcat->id."/".$subcat->subcategory_slug_tr)}}">
